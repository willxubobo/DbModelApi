...
namespace NET.Framework.Common.Extensions
{
    ...
    public static class ParamterCheckExtensions
    {
        ...
        public static void CheckNotNullOrEmpty<T>(this IEnumerable<T> collection, string paramName)
        {
            ...
            enumerable.CheckNotNull(paramName);
            Require<ArgumentException>(enumerable.Any(),
            ...
            where T : IComparable<T>
        {
            ...
            string format = canEqual
                ? Resources.ParameterCheck_NotLessThanOrEqual
                : Resources.ParameterCheck_NotLessThan;
